...
export default function CourseCard({imgUrl,title,about,style,mode,mode2}) {
    ...
    return (
        <>
            <div className={`card m-auto mb-4 ${mode|| mode2===true?"courseCardswhite":""} shadow style${style===true?"2":"1"}`}  >
                ...
                <div className="card-body">
                    ...
                    <p className={`card-text ${mode|| mode2===true?"courseCardswhitenot":""}  p-2 text-${style===true?"center":""}`}>{about}</p>
